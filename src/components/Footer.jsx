    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.footerTop}>
          <div className={styles.footerColContacts}>
            <p className={styles.footerSectionTitle}>Контакты</p>
            <a className={styles.footerLink} href="mailto:press.rt@nationalpriority.ru">press.rt@nationalpriority.ru</a>

            <div className={styles.footerOwner}>
              <span>© Минэкономразвития РФ</span>
              <span>Адрес: Пресненская наб., д. 10, стр. 2, г. Москва, 123112</span>
              <span>E-mail: <a className={styles.footerLink} href="mailto:mineconom@economy.gov.ru">mineconom@economy.gov.ru</a></span>
              <span style={{ marginTop: 8 }}>Цитирование текстовых материалов портала разрешено при обязательном указании активной гиперссылки на источник <a className={styles.footerLink} href="/">путешествуем.рф</a>. Иное использование материалов без письменного согласия правообладателя запрещено.</span>
            </div>
          </div>
